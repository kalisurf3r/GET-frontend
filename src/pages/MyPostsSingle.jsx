  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen">
      <div className="w-1/2 border-2 border-black border-dotted p-2">
        <div className="border-2 border-black p-2 flex">
          <h1>{post.title}</h1>
          <div className="votes flex ml-auto">
          <h3 className="likes mr-1">{post.likes}</h3>
          <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="23"
                fill= "currentColor"
                className="bi bi-hand-thumbs-up-fill mr-1"
                viewBox="0 0 16 16"
              >
          ...
          <h3 className="dislikes mr-1">{post.dislikes}</h3>
          <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="23"
