...
<div className="w-full max-w-4xl lg:w-3/4 xl:w-2/3 mx-auto shadow-lg border-4 border-gray-200 border-dotted hover:border-green-500 transition-colors duration-300 p-4 mb-6 mt-10 lg:scale-110 lg:p-8 px-4 sm:px-6 md:px-8 mx-4 sm:mx-6">
        <div className="border-2 border-gray-300 p-2 flex flex-col sm:flex-row sm:items-center md:p-4 lg:p-6 xl:p-8">
          ...
          <div className="votes flex ml-auto">
            ...
            <h3 className="dislikes mr-1 text-lg md:text-xl lg:text-2xl font-semibold text-gray-200 mr-1 transition-transform duration-300 ease-in-out hover:scale-110">{post.dislikes}</h3>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="23"
              height="23"
        ...
        <p className="text-center text-lg md:text-xl lg:text-2xl text-gray-300 mt-4 leading-relaxed tracking-wide px-4 lg:px-8 transition-transform duration-300 hover:scale-105">{post.content}</p>
      </div>
    </div>
    </div>
  );
